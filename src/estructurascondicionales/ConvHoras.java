...
public class ConvHoras {
    public static void main(String[] args) {
        ...
        System.out.println("Programa para convertir en formatode 24 a formato 12 horas");
        ...
        if((h24 < 24 )&& (h24 > 0)){
            if(((h24 >= 0) && (h24 <= 24)) && ((m24 >= 0) && (m24 <= 60))) {
                ...
                System.out.println("Equivale a " +h12 + " horas " +m12 +" minutos " +periodo);
            }
        }
        else {
            if (h24 == 0){
                ...
                if (h24 == 24){
                    ...
                    System.out.println("El tiempo de " +h24 +" minutos ");
                    System.out.println("Equivale a " +h12 + " horas " +m12 +" minutos " +periodo);
                }
            }
        }
